$(document).ready(function(){
  ...
  //   bar
    ...
    let else_block=document.querySelector(".else_block");
    $.ajax({
      url:"information/else.json",
      success:function(result){
        for(let i=1;i<result.length;i++){
          else_block.innerHTML+="<div class='content_block_1'><img class='Horizontal_img' src='"+
        result[i]['img']+"'alt='"+
        result[i]['name']+"'><p class='text_center'>"+
        result[i]['name']+"</p></div>"
        }
